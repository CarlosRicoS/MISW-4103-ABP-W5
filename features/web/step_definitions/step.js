...
Then("The url now shouldn't have parameters", async function () {
...
Then("The url now should have the author parameter", async function () {
  const { expect } = await import("expect-webdriverio");
  return await expect(this.driver).toHaveUrl(
...
Then("The url now should have the news tag parameter", async function () {
  const { expect } = await import("expect-webdriverio");
  return await expect(this.driver).toHaveUrl(
...
Then("The url now should have the order parameter", async function () {
  const { expect } = await import("expect-webdriverio");
  return await expect(this.driver).toHaveUrl(
...
Then(
  "I should see the page in the admin section as a draft",
  async function () {
...
Then(
  "I should see the post in the admin section as a draft",
  async function () {
