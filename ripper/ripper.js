...
//Constants
var screenshots_directory = './ripper/screenshots';
const beforeInteraction = 'BEFORE';
const afterInteraction = 'AFTER';
var temp_directory = './ripper/temp'; //Stores the visitedDOMs
...
(async () => {
  ...
  for (b of browsers) {
    ...
    console.log(b);
    let basePath = `./ripper/results/${datetime}/${b}`
    ...
    fs.copyFileSync('./ripper/index.html', `${basePath}/report.html`);
  }
